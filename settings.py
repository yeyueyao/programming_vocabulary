...
# 数据库名
DATABASE = os.path.join(_BASEDIR, 'fortest2.db')

# 需要遍历的文件夹
DIRS = [
    # 示例， 该文件夹在项目文件夹下，名为 'files'
    os.path.join(_BASEDIR, 'files'),
    # os.path.join(_BASEDIR, 'download'),
]
...
# 每本书抓取的词汇量
NUMBERS = [
    (100, 100),  # 小于 100 取 10 个
    (1000, 1000),  # 100 - 1000 取 100 个
    (5000, 5000),
    (10000, 10000),
    (50000, 50000),
    (2 ** 31, 100000)  # 大于 50000 统一取 1500
]
...
exclude_list = [
    ...
    # 其他
    'or', 'if', 'else', 'for', 'have', 'must', 'has', 'new', 'time', 'void', 'init', 'class', 'function', 'write',
    'clone', 'thanks', 'clean', 'install', 'using', 'should', 'there', 'doing', 'clouds', 'servers', 'makes', 'redis',
    'mongodb', 'php', 'objective', 'files', 'file', 'swfit', 'center', 'handles', 'welcome', 'focus', 'developed',
    'local', 'processing', 'calling', 'printing', 'typing'
]
